...
| `PUBLIC_PHONE` | Numéro CTA principal (E.164) | `+33623531959` |
| `PUBLIC_PHONE_DISPLAY` | Numéro CTA principal (affiché) | `06 23 53 19 59` |
| `PUBLIC_PHONE_OFFICE` | Standard agence (E.164) | `+33493160631` |
| `PUBLIC_PHONE_OFFICE_DISPLAY` | Standard agence (affiché) | `04 93 16 06 31` |
| `PUBLIC_WHATSAPP` | Numéro WhatsApp sans `+` | `33623531959` |
...
## 4. Téléphone : pourquoi `06 23 53 19 59` et pas `04 93 16 06 31` ?
